...
public class PostTestCAse {
	...
	//validate if Add Place API is working
		...
		.then().assertThat().statusCode(200).body("address",equalTo(newAddress));//.log().all();
		...
		//get place
				...
				String respUpdatedAddress=js1.getString("address");
				System.out.println(respUpdatedAddress);
				
				Assert.assertEquals(respUpdatedAddress, newAddress);
