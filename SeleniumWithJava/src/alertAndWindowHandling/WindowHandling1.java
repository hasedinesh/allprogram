...
public class WindowHandling1 {
	...
	public static void main(String[] args) {
		...
		// To move across all tab create cursor of Iterator interface(Iterator support
		// any type of object)
		Iterator<String> itr = allWindowID.iterator();
		System.out.println(itr.next());
		// To move to second tab either we can remove home tab or we can type itr.next
		// two times.
		...
		// driver.close();
		// System.out.println(driver.getCurrentUrl());//this will give
		// NoSuchWindowException as window is closed.
		// when we close current tab then driver will not automatically move to original
		// home tab.We neet to switch again to hometab.
